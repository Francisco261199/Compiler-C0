...
happyExpList = Happy_Data_Array.listArray (0,122) ([12800,32770,4098,0,0,64,0,0,0,32,0,0,0,0,0,16384,70,80,64,0,632,0,0,8126,25600,4,5,0,0,0,0,0,0,0,0,17152,0,30720,2,0,0,0,3172,1280,4096,0,8576,0,0,2016,24576,8,0,0,0,0,0,8192,0,0,497,0,0,32768,33,0,268,0,2144,0,17152,0,6144,2,49152,16,0,134,0,1072,0,8576,0,3072,1,24576,8,0,63488,0,49152,7,0,62,0,496,0,3968,0,31744,0,0,0,0,0,0,0,0,1792,0,14336,0,0,0,8992,10240,0,252,0,0,0,0,0,0,0,4496,5120,0,0,0,0
	])
...
action_4 (10) = happyShift action_20
...
action_10 (23) = happyShift action_32
action_10 (24) = happyShift action_33
action_10 (26) = happyShift action_34
action_10 (27) = happyShift action_35
action_10 (28) = happyShift action_36
action_10 (29) = happyShift action_37
action_10 (30) = happyShift action_38
action_10 (31) = happyShift action_39
...
action_23 (10) = happyShift action_13
...
action_39 (15) = happyShift action_16
...
action_53 (25) = happyShift action_55
...
action_56 (33) = happyShift action_57
...
happyReduction_9 (HappyTerminal (NUM_TOK happy_var_1))
	 =  HappyAbsSyn6
		 (Num happy_var_1
	)
...
happyReduction_10 (HappyTerminal (VAR_TOK happy_var_1))
	 =  HappyAbsSyn6
		 (Var happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	NUM_TOK happy_dollar_dollar -> cont 9;
	VAR_TOK happy_dollar_dollar -> cont 10;
	TRUE_TOK -> cont 11;
	FALSE_TOK -> cont 12;
	INT_DEF_TOK -> cont 13;
	BOOL_DEF_TOK -> cont 14;
	LPAREN_TOK -> cont 15;
	RPAREN_TOK -> cont 16;
	ASSIGN_TOK -> cont 17;
	LBRACE_TOK -> cont 18;
